      ...
      <Grid container>
        <Grid item xs={12}>
          <Carousel
            ...
            infiniteLoop={true}
          >
            {isEdit ? siteEdit.cover && siteEdit.cover.map((row) => (
              <img style={{ height: '50vh' }} src={row} alt="./images/theme1-banner1.jpg" />
            )) : (
                siteView.cover && siteView.cover.map((row) => (
                  <img style={{ height: '50vh' }} src={row} alt="./images/theme1-banner1.jpg" />
                )))}
          </Carousel>
        </Grid>
        ...
        <Grid item xs={12}>
          {isEdit && !siteEdit && (<p style={classes.changableBody3}>Welcome!</p>)}
          {!isEdit && !siteView && (<p style={classes.changableBody3}>Welcome!</p>)}
        ...
        <Grid item xs={12}>
          <Parallax
            blur={0}
            bgImage={isEdit ? siteEdit.cover && siteEdit.cover[0] : siteView.cover && siteView.cover[0]}
