    ...
    return (
      <>
        <Grid container>
          ...
          {this.props.isPreview ? (
            <Grid container item sm={12} xs={12} justify="center" style={{ background: "black" }}>
              <Grid item xs={12} style={{ background: "white", overflowY: "scroll", overflowX: "hidden", height: "100vh" }}>
                {this.props.children}
              </Grid>
            </Grid>
          ) : (
              <Grid container item sm={9} xs={12} justify="center" style={{ background: "black" }}>
                <Grid item xs={12} style={{ background: "white", overflowY: "scroll", overflowX: "hidden", height: "100vh" }}>
                  {this.props.children}
                </Grid>
              </Grid>
          ...
          <IconButton
            ...
            <FontAwesomeIcon
              icon={this.props.isPreview ? faArrowCircleRight : faArrowCircleLeft}
              color="#0074aa"
              size="xs"
            />
          </IconButton>
